...
class Reccuring extends Controller
{
    public function getRecurring(Request $request)
    {
        try {
            $Recurring = RecurringModel::with('category')->get();
    ...
    public function addReccuring(Request $request)
    {
        echo 'Hello';
        try {
            $request->validate(
    ...
    public function updateIncome(Request $request, $id)
    {
        ...
        try {
            $income = RecurringModel::findOrFail($id);
    ...
    {
        try {
            $res = RecurringModel::orderBy('date_time', 'asc')
                ->get();
            return response()->json([
                'status' => 'success',
                'SortByDateAsc' => $res
    ...
    {
        try {
            $res = RecurringModel::orderBy('date_time', 'desc')
                ->get();
            return response()->json([
                'status' => 'success',
                'SortByDateAsc' => $res
    ...
    {
        try {
            $res = RecurringModel::orderBy('amount', 'desc')
                ->get();
            return response()->json([
                'status' => 'success',
                'SortByDateAsc' => $res
    ...
    {
        try {
            $res = RecurringModel::orderBy('title', 'desc')
                ->get();
            return response()->json([
                'status' => 'success',
                'SortByDateAsc' => $res
